...
export default function Home() {
  ...
  const makePayment = async (e, manualOrderId = null) => {
    ...
    let data = { id: manualOrderId || form.orderId, currency: "INR", amount: parseInt(form.amount) * 100 };
  ...
  return (
    <div className="min-h-screen bg-[#111827] text-white font-sans selection:bg-indigo-500/30">
      <Head>
        ...
        <meta name="description" content="Test your Razorpay backend implementation easily." />
      </Head>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Test your backend API or manually trigger payments using existing Order IDs.
          </p>
        </div>
        ...
        <div className="bg-[#1F2937] border border-gray-700/50 rounded-2xl p-8 shadow-2xl">
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-300">Order ID (Optional)</label>
                <input
                  type="text"
                  name="orderId"
                  value={form.orderId}
            ...
            {!form.orderId && (
              <p className="text-center text-xs text-gray-500 italic">
                * This will call your /api/razorpay backend to generate a new Order ID.
              </p>
            )}
          </form>
        </div>
        ...
        <div className="mt-12 text-center text-gray-500 text-sm">
          <p>Created for testing purposes. Don't use real credentials.</p>
        </div>
      </main>
    </div>
  );
